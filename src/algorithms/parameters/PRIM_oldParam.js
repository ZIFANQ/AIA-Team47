...
function PRIM_oldParam({ mode, xyCoords, edgeWeights, size, start, end, heuristic, min, max }) {
...
export default withAlgorithmParams(PRIM_oldParam); // Export with the wrapper for URL Params
